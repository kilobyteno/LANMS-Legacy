...
ALTER TABLE `news` CHANGE `author_id` `editor_id` INT(11) NOT NULL AFTER `category_id`;
ALTER TABLE `news` ADD `author_id` INT NOT NULL AFTER `category_id`;
ALTER TABLE `news` CHANGE `editor_id` `editor_id` INT(11) NOT NULL AFTER `author_id`;

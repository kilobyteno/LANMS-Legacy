...
return [
    ...
    'consentform' => array(
        ...
        'moreinfo' => 'Vi har samlet informasjon til omsorgsperson på nettsiden vår: <br><strong><em>:url</em></strong>',
        'permission' => 'Tillatelse til å delta på :event',
        'permissiondesc' => 'Jeg gir med dette tillatelse til at <em>:name</em> som er født <em>:birthdate</em> kan delta på arrangementet ":event" i :location. Jeg gir med dette tillatelse til arrangørene som nevnt i punktene over.',
    ...
    'seat' => array(
        ...
        'more_info' => 'For mer informasjon sjekk vår nettside',
    ),

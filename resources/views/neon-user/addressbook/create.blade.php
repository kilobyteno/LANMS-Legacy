					...
					<div class="panel-body">
						...
						<div class="row">
							...
							<div class="col-sm-5 form-group @if($errors->has('address1')) has-error @endif">
								<input class="form-control" type="text" name="address1" placeholder="Jernbanegata 15">
						...
						<div class="row">
							...
							<div class="col-sm-5 form-group @if($errors->has('postalcode')) has-error @endif">
								<input class="form-control" type="text" name="postalcode" placeholder="2609">
						...
						<div class="row">
							...
							<div class="col-sm-5 form-group @if($errors->has('city')) has-error @endif">
								<input class="form-control" type="text" name="city" placeholder="Lillehammer">
								@if($errors->has('city'))
						...
						<div class="row">
							...
							<div class="col-sm-5 form-group @if($errors->has('county')) has-error @endif">
								<input class="form-control" type="text" name="county" placeholder="Oppland">
						...
						<div class="row">
							...
							<div class="col-sm-5 form-group @if($errors->has('country')) has-error @endif">
								<input class="form-control" type="text" name="country" placeholder="Norway">

		...
		<div class="col-md-12">
			...
			<div class="row">
				...
				<div class="col-lg-4">
					...
					<h3>Reservations</h3>
					<div class="list-group">
						<a href="{{ route('account-reservation') }}" class="list-group-item"><i class="fa fa-street-view"></i> Reservations <span class="badge badge-primary">{{ \Sentinel::getUser()->reservations->count() }}</span></a>
					</div>

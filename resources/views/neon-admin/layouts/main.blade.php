			...
			<div id="main-menu" class="main-menu">
				...
				<li class="@if(Request::is('admin/seating*')){{'active opened'}} @endif has-sub root-level">
					...
					<ul>
						...
						<li class="@if(Request::is('admin/seating/brokenband*')){{'active'}} @endif"><a href="{{ route('admin-seating-brokenband') }}"><i class="fa fa-chain-broken"></i> <span class="title">Broken Band</span></a></li>
					</ul>
				</li>

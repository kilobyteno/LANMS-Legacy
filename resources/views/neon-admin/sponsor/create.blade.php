...
<div class="row">
	<div class="col-md-12">
		...
		<h1 class="margin-bottom">Create Sponsor</h1>
		<ol class="breadcrumb 2">
			<li><a href="{{ route('home') }}"><i class="fa fa-home"></i>Home</a></li>
			<li><a href="{{ route('admin') }}">Admin</a></li>
			<li><a href="{{ route('admin-sponsor') }}">Sponsor</a></li>
			<li class="active"><strong>Create Sponsor</strong></li>
		</ol>
				...
				<div class="col-sm-5">
					<div class="panel panel-primary @if($errors->has('name')) panel-danger @endif" data-collapsed="0">
						...
						<div class="panel-body">
							<input type="text" class="form-control input-lg" name="name" placeholder="Alphabet Inc." value="{{ (old('name')) ? old('name') : '' }}" />
							@if($errors->has('name'))
						...
						<div class="panel-body">
							<div class="fileinput fileinput-new" data-provides="fileinput">
								<div class="fileinput-new thumbnail" style="max-width: 335px; height: 90px;" data-trigger="fileinput">
									<img src="http://placehold.it/335x90" alt="...">
								</div>

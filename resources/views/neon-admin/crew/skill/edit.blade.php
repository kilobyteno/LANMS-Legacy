...
<div class="row">
	<div class="col-md-12">
		...
		<h1 class="margin-bottom">Edit Skill: <small>{{ $skill->name }}</small></h1>
		<ol class="breadcrumb 2">
			<li><a href="{{ route('home') }}"><i class="fa fa-home"></i>Home</a></li>
			<li><a href="{{ route('admin') }}">Admin</a></li>
			<li><a href="{{ route('admin-crew') }}">Crew</a></li>
			<li><a href="{{ route('admin-crew-skill') }}">Skill</a></li>
			<li class="active"><strong>Edit Skill #{{ $skill->id }}</strong></li>
		</ol>
		...
		<form action="{{ route('admin-crew-skill-update', $skill->id) }}" method="post">
			...
			<div class="row">
				...
				<div class="col-sm-5 @if($errors->has('label')) has-error @endif">
					...
					<p>Available labels can be found here: <a href="http://getbootstrap.com/components/#available-variations" target="_blank">getbootstrap.com</a></p>
					@if($errors->has('label'))

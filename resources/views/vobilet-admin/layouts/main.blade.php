									...
									<div class="dropdown">
										<a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
											...
											<span class="ml-2 d-none d-lg-block">
												<span class="@if(Sentinel::getUser()->theme == 'dark'){{ 'text-light' }}@else{{ 'text-dark' }}@endif" id="usermenu">{{ Sentinel::getUser()->firstname }}@if(Sentinel::getUser()->showname && Sentinel::getUser()->lastname) {{ Sentinel::getUser()->lastname }}@endif <i class="fas fa-caret-up"></i></span>
											</span>
										</a>

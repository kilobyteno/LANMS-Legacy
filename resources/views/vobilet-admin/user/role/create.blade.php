			...
			<div class="card-body">
				<form action="{{ route('admin-role-store') }}" method="post">
					...
					<div class="input-group mb-5">
						...
						<input type="text" class="form-control input-lg" name="name" autocomplete="off" placeholder="Editor" value="{{ (old('name')) ? old('name') : '' }}" />
					...
					<div class="input-group">
						@foreach($role->permissions as $k => $v)
							<label class="custom-control custom-checkbox mr-3 mb-2">
								<input type="checkbox" class="custom-control-input" type="checkbox" name="permission-{{ $k }}">

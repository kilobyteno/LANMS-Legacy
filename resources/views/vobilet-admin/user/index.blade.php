					...
					<tbody>
						@foreach($users as $user)
							<tr>
								...
								<td>@if(\Activation::completed($user))<div class="badge badge-primary">Activated</div>@endif @if($user->last_login)<div class="badge badge-info">Has logged in</div>@endif @if($user->deleted_at)<div class="badge badge-secondary">Deactivated</div>@endif</td>
								<td>

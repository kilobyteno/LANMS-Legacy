								...
								<div class="form-row">
									...
									<div class="col-xl-6">
										<div class="input-group">
											...
											<input type="text" class="form-control input-lg {{ ($errors->has('toornament_id')) ? 'is-invalid state-invalid' : '' }}" name="toornament_id" autocomplete="off" placeholder="Toornament ID" value="{{ (old('toornament_id')) ? old('toornament_id') : '' }}" />
									...
									<div class="col-xl-6">
										<div class="input-group">
											...
											<input type="text" class="form-control input-lg {{ ($errors->has('toornament_stage_id')) ? 'is-invalid state-invalid' : '' }}" name="toornament_stage_id" autocomplete="off" placeholder="Toornament Stage ID" value="{{ (old('toornament_stage_id')) ? old('toornament_stage_id') : '' }}" />

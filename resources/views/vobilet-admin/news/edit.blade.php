...
<div class="page-header">
	<h4 class="page-title">Edit Article: {{ $article->title }}</h4>
	<ol class="breadcrumb">
		<li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
		<li class="breadcrumb-item"><a href="{{ route('admin') }}">Admin</a></li>
		<li class="breadcrumb-item"><a href="{{ route('admin-news') }}">News</a></li>
		<li class="breadcrumb-item active" aria-current="page">Edit Article #{{ $article->id }}</li>
	</ol>
</div>
								...
								<div class="expanel-body">
									...
									<div class="form-group @if($errors->has('active')) text-danger @endif">
										<label class="custom-control custom-checkbox">
											<input type="checkbox" class="custom-control-input" name="active" @if($article->active) checked @endif>
									...
									<div class="row">
										<div class="col-md-6">
											...
											<div class="input-group">
												...
												<input class="form-control datepicker" name="published_at_date" type="text" data-date-format="yyyy-mm-dd" value="{{ (old('published_at_date')) ? old('published_at_date') : date('Y-m-d', strtotime($article->published_at)) }}">
										...
										<div class="col-md-6">
											...
											<div class="input-group">
												...
												<input class="form-control ui-timepicker-input @if($errors->has('published_at_time')) is-invalid state-invalid @endif" id="published_at_time" placeholder="Set time" type="text" autocomplete="off" name="published_at_time" value="{{ (old('published_at_time')) ? old('published_at_time') : date('H:i', strtotime($article->published_at)) }}">
							...
							<div class="expanel expanel-default @if($errors->has('slug')) expanel-danger @endif" data-collapsed="0">
								...
								<div class="expanel-body">
									<div class="input-group">
										...
										<input type="text" class="form-control" value="{{ (old('slug')) ? old('slug') : $article->slug }}" name="slug">
									</div>
									@if($errors->has('slug'))

...
@section('title', trans('user.profile.changeimages.title'))
@section('content')

<div class="container">
	<div class="page-header">
		<h4 class="page-title">{{ trans('user.profile.changeimages.title') }}</h4>
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">{{ trans('user.profile.changeimages.title') }}</li>
		</ol>
	</div>
	<div class="row">
		<div class="col-md-12">
		...
		<div class="col-md-6">
			<form class="card" role="form" method="post" action="{{ route('account-change-image-profile-post') }}" enctype="multipart/form-data">
				...
				<div class="card-header">
					<h3 class="card-title">{{ trans('user.profile.changeimages.profilephoto') }}</h3>
				</div>
				<div class="card-body">
				...
				<div class="card-footer text-right">
					...
					<button type="submit" class="btn btn-success"><i class="fas fa-upload"></i> {{ trans('user.profile.changeimages.button') }}</button>
				</div>
			</form>
		</div>
		<div class="col-md-6">
			<form class="card" role="form" method="post" action="{{ route('account-change-image-cover-post') }}" enctype="multipart/form-data">
				...
				<div class="card-header">
					<h3 class="card-title">{{ trans('user.profile.changeimages.coverphoto') }}</h3>
				</div>
				<div class="card-body">
					<div class="form-group">
						<div class="custom-file">

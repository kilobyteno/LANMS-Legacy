...
@section('title', trans('user.account.billing.card.create.title'))
@section('content')

<div class="container">
    <div class="page-header">
        <h4 class="page-title">{{ trans('user.account.billing.card.create.title') }}</h4>
        <ol class="breadcrumb">
					...
					<form role="form" id="payment-form" method="post" action="{{ route('account-billing-card-store') }}">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<button class="btn btn-success btn-lg btn-block" type="submit"><i class="fas fa-save"></i> {{ trans('global.savechanges') }}</button>
							</div>
						</div>

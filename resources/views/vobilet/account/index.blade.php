					...
					<div class="card">
						...
						<div class="">
							<table class="table card-table">
								<tbody>
									<tr class="border-bottom">
										<td><a href="{{ route('account-billing-payments') }}" class="text-inherit"><i class="fas fa-money-bill-alt"></i> {{ trans('user.account.billing.payments') }} <span class="badge badge-default">{{ \Sentinel::getUser()->seatpayments->count() }}</span></a></td>
									</tr>
									<tr class="border-bottom">

...
<div class="container text-center">
	<div class="page-header">
		<h4 class="page-title">{{ __('pages.errors.429.title') }}</h4>
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="{{ url('/') }}">{{ __('header.home') }}</a></li>
			<li class="breadcrumb-item active" aria-current="page">{{ __('pages.errors.429.title') }}</li>
		</ol>
	</div>
	<div class="row">
		<div class="col-lg-12">
			<div class="display-1 mb-5">429</div>
			<h1>{{ __('pages.errors.429.desc') }}</h1>

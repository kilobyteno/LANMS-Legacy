...
@section('title', trans('global.edit').' '.trans('compo.teams'))
@section('content')
				...
				<div class="card-body">
					<div class="form-group">
						<div class="input-group">
							<input class="form-control" type="text" name="name" placeholder="{{ trans('compo.team.create.name') }}" value="{{ old('name') ?? $team->name }}">
						</div>
						@if($errors->has('name'))

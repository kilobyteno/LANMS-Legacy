...
<div class="container">
	<div class="page-header">
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">{{ __('seating.checkin.title') }}</li>
		</ol>
	</div>
	<div class="row">
		<div class="col-md-12">
			<div class="alert alert-info" role="alert"><i class="fas fa-info mr-2" aria-hidden="true"></i> {{ __('seating.checkin.info') }}</div>
			<div class="card card-profile " style="background: url({{ '/images/profilecover/0.jpg' }}); background-size:cover;min-height: 300px">
				<div class="card-body text-center">
					<div class="d-flex flex-row align-items-center justify-content-center" style="min-height: 300px">
						<div class="col-6">
							<h3 class="text-white">{{ __('seating.checkin.subtitle') }}</h3>

                ...
                <td colspan="2">
                    <table>
                        <tr>
                            ...
                            <td>
                                Reservation #: {{ $payment->reservation->id }}<br>
                                Date: {{ date(User::getUserDateFormat(), strtotime($payment->reservation->created_at)) .' at '. date(User::getUserTimeFormat(), strtotime($payment->reservation->created_at)) }}<br>
                            </td>
                        </tr>
                    </table>
                </td>
